...
class PointNet1(nn.Module):
    def __init__(self,input_num1,input_num2,out_num):
        ...
        self.block51 = nn.Conv1d(in_channels=576,out_channels=512,kernel_size=1)
        self.block61 = nn.Conv1d(in_channels=512,out_channels=256,kernel_size=1)
        
        self.block52 = nn.Conv1d(in_channels=576,out_channels=512,kernel_size=1)
        self.block62 = nn.Conv1d(in_channels=512,out_channels=256,kernel_size=1)
        ...
        self.bct51 = nn.BatchNorm1d(512)
        self.bct61 = nn.BatchNorm1d(256)
        
        self.bct52 = nn.BatchNorm1d(512)
        self.bct62 = nn.BatchNorm1d(256)
    ...
    def forward(self, x):
        ...
        x1 = torch.relu(self.bct51(self.block51(x1)))
        x1 = torch.relu(self.bct61(self.block61(x1)))
        
        x2 = torch.relu(self.bct52(self.block52(x2)))
        x2 = torch.relu(self.bct62(self.block62(x2)))
